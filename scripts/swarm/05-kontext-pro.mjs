// Swarm agent: Flux Kontext Pro — image editing with prompts
// v1 — 2026-02-20
...
const MODEL_NAME = "kontext-pro";
const CONCURRENCY = 3; // Lower concurrency for Pro model

async function generate(style, imageUrl) {
  try {
    const result = await fal.subscribe("fal-ai/flux-pro/kontext", {
      input: {
        prompt: `Transform this photo: ${style.prompt}`,
        image_url: imageUrl,
        num_images: 1,
        guidance_scale: 3.5,
      },
